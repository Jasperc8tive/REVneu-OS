    ...
    <div className="min-h-screen bg-gray-100 flex">
      <aside className="w-64 bg-brand-primary text-white flex flex-col shrink-0">
        <div className="px-6 py-5 border-b border-blue-800">
          ...
          <p className="text-xs text-blue-200 mt-1">Growth Control Center</p>
        </div>
        ...
        <div className="px-4 py-4 border-t border-blue-800">
          <p className="text-xs text-blue-300 font-mono">Stage 5 - UI Layer in progress</p>
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm text-gray-500">Growth trial active</span>
